...
insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(1,'CARLOS DA SILVEIRA MELO','1973-06-02','M','1994-05-20','C',3200);
...
insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(3,'ROBERTO RAMALHO','1981-10-15','M','1998-05-07','C',4600);
...
insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(4,'NATHAN FARCCA','1984-06-30','M','1990-05-12','S',5300);
...
insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(4,'MELANI CARVALHO','1970-08-12','F','1999-04-20','S',12000);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(4,'MARCOS CARVALHO NETO','2010-01-25','M');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(4,'ANA CARLA MENINO','1963-12-22','F','2003-02-21','V',24000);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(4,'ANALDER MENINO','1999-01-01','M');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(4,'CARLOS PETTRA','1985-11-18','M','2005-02-19','S',3500);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(5,'LUAN ANTONIO PETTRA','2010-12-25','M');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(5,'CIRLO SENA','1985-12-22','M','2003-08-20','C',2400);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(6,'ANTONI SENA FILHO','2011-09-09','M');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(2,'CARLOS KITAYMA','1985-03-30','M','2002-12-20','C',3600);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(6,'LEONARDO MARCOS SENA','2005-11-08','M');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(2,'MARCOS MAEMURA','1981-07-09','M','2005-11-01','V',4500);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(4,'ALINE MAEUMURA','2006-08-17','F');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(5,'JOÃO ROBERTO BAIRRO','1984-10-10','M','2001-05-02','C',4500);
...
insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(3,'SILVIO MORGATO','1966-06-10','M','1997-05-02','C',4800);
...
insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(2,'ANA CARVALHO FERREIRA','1977-08-15','F','1994-03-20','V',5200);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(10,'JOÃO FRANCISCO MORGATO','2012-03-30','M');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(4,'ANTONIO MARCONATO','1979-09-26','M','1992-05-02','V',7500);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(11,'ALLIAN PEREIRA MATOS','2011-03-03','M');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(4,'ANTONIO SINTALA','1973-03-02','M','1992-05-18','D',8500);
insert into dependente(cod_emp, nome, dt_nascimento, sexo) values(12,'CLARICE MARCONATO','2011-10-08','F');

insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(3,'MARIA FELÍCIA MARCELINO','1979-02-12','F','1993-02-26','C',6900);
...
insert into empregado(cod_depto, nome, dt_nascimento, sexo, dt_admissao, estado_civil, salario) values(2,'FERNANDO SINTALA','1980-06-18','M','2003-02-03','D',2500);
